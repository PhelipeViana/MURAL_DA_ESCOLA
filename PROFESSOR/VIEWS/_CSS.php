<?php 
$COR_PRINCIPAL=$DADOS[0]['cor_sistema'];
?>
<style>
    .card {
        font-size: .875rem;
    ...
    *::after {
    ...
    .bg-primary {
        background-color: #517cf4 !important;
    }
    ...
    .is-focused .form-control {
        background-image: linear-gradient(to top, #517cf4 2px, rgba(156, 39, 176, 0) 2px), linear-gradient(to top, #d2d2d2 1px, rgba(210, 210, 210, 0) 1px);
    }
